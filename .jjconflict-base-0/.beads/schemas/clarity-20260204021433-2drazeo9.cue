...
// Validation schema for bead: clarity-20260204021433-2drazeo9
// Title: foundation: Exit code system
//
// This schema validates that implementation is complete.
// Use: cue vet clarity-20260204021433-2drazeo9.cue implementation.cue

#BeadImplementation: {
  bead_id: "clarity-20260204021433-2drazeo9"
  title: "foundation: Exit code system"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      ...
      "Usage error returns 4",
    ]

    // Required error path tests
    required_error_tests: [
      "Unknown exit code handled",
    ]
  }
