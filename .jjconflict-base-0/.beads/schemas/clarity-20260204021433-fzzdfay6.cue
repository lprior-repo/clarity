...
// Validation schema for bead: clarity-20260204021433-fzzdfay6
// Title: foundation: Implement type system (HttpMethod, SpecName, Url, etc.)
//
// This schema validates that implementation is complete.
// Use: cue vet clarity-20260204021433-fzzdfay6.cue implementation.cue

#BeadImplementation: {
  bead_id: "clarity-20260204021433-fzzdfay6"
  title: "foundation: Implement type system (HttpMethod, SpecName, Url, etc.)"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Valid types construct successfully",
      "Invalid types return Err",
      "Conversions work",
    ]
