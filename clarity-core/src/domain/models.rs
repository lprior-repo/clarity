...
impl User {
    ...
    pub fn update_password(&mut self, new_hash: String) -> Result<(), ModelError> {
...
impl Bead {
    ...
    pub fn update_title(&mut self, title: String) -> Result<(), ModelError> {
        Self::validate_title(&title)?;
        self.title = title;
        self.updated_at = Utc::now();
        Ok(())
    ...
    pub fn transition_to(&mut self, new_status: BeadStatus) -> Result<(), ModelError> {
