...
impl OutputFormat {
  ...
  pub fn try_from_str(s: &str) -> Result<Self, FormatError> {
...
mod tests {
  ...
  fn test_parse_format_from_invalid_string_returns_error() {
    let result = OutputFormat::try_from_str("xml");
  ...
  fn test_parse_format_from_valid_strings() {
    assert_eq!(OutputFormat::try_from_str("json").unwrap(), OutputFormat::Json);
    assert_eq!(OutputFormat::try_from_str("JSON").unwrap(), OutputFormat::Json);
    assert_eq!(
      OutputFormat::try_from_str("markdown").unwrap(),
      OutputFormat::Markdown
    );
    assert_eq!(
      OutputFormat::try_from_str("md").unwrap(),
      OutputFormat::Markdown
    );
    assert_eq!(
      OutputFormat::try_from_str("text").unwrap(),
      OutputFormat::PlainText
    );
    assert_eq!(
      OutputFormat::try_from_str("txt").unwrap(),
      OutputFormat::PlainText
    );
  }
