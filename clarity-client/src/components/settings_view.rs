...
use crate::hooks::use_settings::{use_beads_per_page_validator, use_settings};
use crate::settings::{BackupFrequency, Theme};
...
#[component]
fn SettingsSection(title: String, description: String, children: Element) -> Element {
  rsx! {
...
#[component]
fn ThemeSelector(theme: Theme, on_change: Callback<Theme>) -> Element {
  rsx! {
...
#[component]
fn PrioritySelector(priority: BeadPriority, on_change: Callback<BeadPriority>) -> Element {
  rsx! {
      div { class: "setting-item",
...
#[component]
fn TypeSelector(bead_type: BeadType, on_change: Callback<BeadType>) -> Element {
  rsx! {
      div { class: "setting-item",
...
#[component]
fn AutoBackupCheckbox(enabled: bool, on_change: Callback<bool>) -> Element {
  rsx! {
      div { class: "setting-item",
...
#[component]
fn DataLocationDisplay(path: std::path::PathBuf) -> Element {
...
#[component]
fn KeyboardShortcutsList(shortcuts: std::collections::HashMap<String, String>) -> Element {
