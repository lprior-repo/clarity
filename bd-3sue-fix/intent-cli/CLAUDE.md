...
**Note**: This project uses [br (beads)](https://github.com/steveyegge/beads) for issue tracking. Use `br` commands instead of markdown TODOs. See AGENTS.md for workflow details.
...
- Creates beads (tasks) from specifications for use with br (beads)
