...
pub fn sample_transcript() -> InterrogationTranscript {
    ...
    transcript.solution = ExtractedField::new(
        "Micro-meditation app with 60-second sessions and smart reminders based on calendar".to_string(),
        0.8,
        "ai".to_string(),
    );
    ...
    transcript.scenario = ScenarioField {
        ...
        value_moment: "Completes a 60-second breathing exercise that actually calms their nerves".to_string(),
        feeling: "Relieved and more focused for their upcoming meeting".to_string(),
        hole_punching: super::types::HolePunchingResults::new()
            .address(super::types::HoleType::DiscoveryHole, "App Store search and productivity blogs".to_string())
            .address(super::types::HoleType::EdgeCaseHole, "Offline mode with cached sessions".to_string())
            .address(super::types::HoleType::MotivationDropOff, "Streak counter and gentle nudges".to_string()),
    };
