...
mod tests {
    ...
    fn test_default_phase_is_prompt() {
        assert_eq!(ProgressiveDiscoverPhase::default(), ProgressiveDiscoverPhase::Prompt);
    }

    #[test]
    fn test_display_formats_correctly() {
        assert_eq!(format!("{}", ProgressiveDiscoverPhase::Prompt), "Prompt");
        assert_eq!(format!("{}", ProgressiveDiscoverPhase::Extracting), "Extracting");
        assert_eq!(format!("{}", ProgressiveDiscoverPhase::ConfirmingFields), "Confirming Fields");
        assert_eq!(format!("{}", ProgressiveDiscoverPhase::Preview), "Preview");
        assert_eq!(format!("{}", ProgressiveDiscoverPhase::KirkCompilation), "KIRK Compilation");
    ...
    fn test_all_phases_count() {
        assert_eq!(ProgressiveDiscoverPhase::all().len(), ProgressiveDiscoverPhase::count());
    ...
    #[test]
    fn test_equality() {
        assert_eq!(ProgressiveDiscoverPhase::Prompt, ProgressiveDiscoverPhase::Prompt);
        assert_ne!(ProgressiveDiscoverPhase::Prompt, ProgressiveDiscoverPhase::Locked);
    }
    ...
    fn test_subphase_display_formats_correctly() {
        ...
        assert_eq!(format!("{}", ConfirmSubPhase::ConfirmNonpersona), "Nonpersona");
    ...
    fn test_subphase_field_names() {
        ...
        assert_eq!(ConfirmSubPhase::ConfirmNonpersona.field_name(), "nonpersona");
