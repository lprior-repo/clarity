...
mod tests {
  ...
  fn test_phase_ordinal_sequence() {
    assert!(
      ProgressiveDiscoverPhase::Prompt.ordinal() < ProgressiveDiscoverPhase::Extracting.ordinal()
    );
    assert!(
      ProgressiveDiscoverPhase::Extracting.ordinal()
        < ProgressiveDiscoverPhase::ConfirmingFields.ordinal()
    );
    assert!(
      ProgressiveDiscoverPhase::ConfirmingFields.ordinal()
        < ProgressiveDiscoverPhase::Preview.ordinal()
    );
    assert!(
      ProgressiveDiscoverPhase::Preview.ordinal()
        < ProgressiveDiscoverPhase::KirkCompilation.ordinal()
    );
    assert!(
      ProgressiveDiscoverPhase::KirkCompilation.ordinal()
        < ProgressiveDiscoverPhase::Locked.ordinal()
    );
  }
  ...
  fn test_sub_phase_ordinal_sequence() {
    ...
    assert!(
      ConfirmSubPhase::ConfirmSolution.ordinal() < ConfirmSubPhase::ConfirmNonpersona.ordinal()
    );
    assert!(
