...
pub fn SelectItemIndicator(props: SelectItemIndicatorProps) -> Element {
    let class_str = if props.class.is_empty() {
        ...
        format!("absolute left-2 flex h-3.5 w-3.5 items-center justify-center {}", props.class)
    };
...
pub fn SelectIcon(props: SelectIconProps) -> Element {
    let class_str = if props.class.is_empty() {
        ...
        format!("ml-2 h-4 w-4 shrink-0 opacity-50 transition-transform {}", props.class)
    };
...
pub fn SelectScrollUpButton(props: SelectScrollUpButtonProps) -> Element {
    let class_str = if props.class.is_empty() {
        ...
        format!("flex cursor-default items-center justify-center py-1 {}", props.class)
    };
