...
impl ButtonVariant {
  pub fn classes(&self) -> &'static str {
    match self {
      ButtonVariant::Default => "bg-secondary text-secondary-foreground hover:bg-secondary/80",
      ButtonVariant::Primary => "bg-primary text-primary-foreground hover:bg-primary/85",
      ButtonVariant::Secondary => "bg-card text-foreground border border-border hover:bg-secondary",
