...
pub fn validate_email(input: &str) -> Result<(), FormatError> {
    ...
    let (local, domain) = input
        .split_once('@')
        .ok_or(EmailError::MissingAtSign)?;
...
pub fn validate_uuid(input: &str) -> Result<(), FormatError> {
    ...
    let variant_char = chars
        ...
        .ok_or(UuidError::WrongLength(input.len()))?;
    if !matches!(
        variant_char.to_ascii_lowercase(),
        '8' | '9' | 'a' | 'b'
    ) {
...
mod tests {
    ...
    fn test_invalid_uuids() {
        let invalid_uuids = vec![
            ...
            ("550e8400e29b41d4a716446655440000", UuidError::WrongLength(32)), // No hyphens, wrong length
            ("550e8400-e29b-41d4-a71644665544000", UuidError::WrongLength(34)), // Missing one char, wrong length
            ("550e8400-e29b-61d4-a716-446655440000", UuidError::InvalidVersion('6')), // v6 invalid
            ("550e8400-e29b-01d4-a716-446655440000", UuidError::InvalidVersion('0')), // v0 invalid
            ("550e8400-e29b-41d4-c716-446655440000", UuidError::InvalidVariant('c')), // c invalid variant
        ];
    ...
    fn test_invalid_uris() {
        let invalid_uris = vec![
            ...
            ("123://invalid-scheme.com", UriError::SchemeMustStartWithLetter),
