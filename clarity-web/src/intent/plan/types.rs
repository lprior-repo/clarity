...
mod tests {
  ...
  fn test_execution_plan_get_phase_beads() {
    let mut plan = ExecutionPlan::new("session-1".to_string());
    plan
      .add_bead(PlanBead::new("b1".to_string(), "Phase 1".to_string(), 1).expect("valid"))
      .expect("should add");
    plan
      .add_bead(PlanBead::new("b2".to_string(), "Phase 2a".to_string(), 2).expect("valid"))
      .expect("should add");
    plan
      .add_bead(PlanBead::new("b3".to_string(), "Phase 2b".to_string(), 2).expect("valid"))
      .expect("should add");
