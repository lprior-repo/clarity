  ...
  match Spec::new("test-spec".to_string()) {
    Ok(mut spec) => {
      ...
      let behavior = match Behavior::new("login".to_string()) {
        Ok(b) => b.with_intent("User logs in".to_string()),
        Err(_) => return spec,
      };
...
mod edge_cases {
  ...
  fn test_empty_string_spec_name() {
    ...
    let behavior = match Behavior::new("test_behavior".to_string()) {
      Ok(b) => b.with_intent("Test behavior".to_string()),
      Err(_) => return,
    };
  ...
  fn test_special_characters_in_description() {
    let spec = match Spec::new("test-spec".to_string()) {
      Ok(mut spec) => {
        ...
        let behavior = match Behavior::new("login".to_string()) {
          Ok(b) => b.with_intent("Login with `backticks` and 'quotes'".to_string()),
          Err(_) => return,
        };
    ...
    let spec = match Spec::new("test-spec".to_string()) {
      Ok(mut spec) => {
        ...
        let behavior1 = match Behavior::new("user_login".to_string()) {
          Ok(b) => b.with_intent("User login".to_string()),
          Err(_) => return,
        };

        let behavior2 = match Behavior::new("user_logout".to_string()) {
          Ok(b) => b.with_intent("User logout".to_string()),
          Err(_) => return,
        };
    ...
    let spec = match Spec::new("test-spec-v2".to_string()) {
      Ok(mut spec) => {
        ...
        let behavior = match Behavior::new("login_2fa".to_string()) {
          Ok(b) => b.with_intent("Two-factor login".to_string()),
          Err(_) => return,
        };
    ...
    let spec = match Spec::new("test-spec".to_string()) {
      Ok(mut spec) => {
        ...
        let behavior = match Behavior::new("b".to_string()) {
          Ok(b) => b.with_intent("Behavior B".to_string()),
          Err(_) => return,
        };
        ...
        for i in 0..1000 {
          ...
          for j in 0..10 {
            let behavior = match Behavior::new(format!("behavior_{i}_{j}")) {
              Ok(b) => b.with_intent(format!("Behavior {i}_{j}")),
              Err(_) => return,
            };
      ...
      Ok(mut s) => {
        ...
        for i in 0..100 {
          ...
          for j in 0..10 {
            ...
            behavior.intent = "TODO: implement".to_string();
    ...
    let spec = match Spec::new("test-spec".to_string()) {
      Ok(mut spec) => {
        ...
        let behavior1 = match Behavior::new("handle".to_string()) {
          Ok(b) => b.with_intent("Handle something".to_string()),
          Err(_) => return,
        };

        let behavior2 = match Behavior::new("process".to_string()) {
          Ok(b) => b.with_intent("Process data".to_string()),
          Err(_) => return,
        };

        let behavior3 = match Behavior::new("execute".to_string()) {
          Ok(b) => b.with_intent("Execute command".to_string()),
          Err(_) => return,
        };

        let behavior4 = match Behavior::new("run".to_string()) {
          Ok(b) => b.with_intent("Run task".to_string()),
          Err(_) => return,
        };

        let behavior5 = match Behavior::new("do".to_string()) {
          Ok(b) => b.with_intent("Do operation".to_string()),
          Err(_) => return,
        };
    ...
    let spec = match Spec::new("test-spec".to_string()) {
      Ok(mut spec) => {
        ...
        let behavior1 = match Behavior::new("handle_user_login".to_string()) {
          Ok(b) => b.with_intent("Handle user login".to_string()),
          Err(_) => return,
        };

        let behavior2 = match Behavior::new("process_payment".to_string()) {
          Ok(b) => b.with_intent("Process payment".to_string()),
          Err(_) => return,
        };
  ...
  fn test_exactly_at_threshold_descriptions() {
    let spec = match Spec::new("test-spec".to_string()) {
      Ok(mut spec) => {
        ...
        let behavior1 = match Behavior::new("login".to_string()) {
          Ok(b) => b.with_intent("12345".to_string()),
          Err(_) => return,
        };

        // Exactly 4 chars (below threshold)
        let behavior2 = match Behavior::new("logout".to_string()) {
          Ok(b) => b.with_intent("1234".to_string()),
          Err(_) => return,
        };
